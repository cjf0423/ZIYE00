...
export inviterNick="F6E2F9A7AFCE6E6D34F6A7039DE0CCAE1C17DBC9A83F15578F2DDCAB310F69C474D05EDAD17077AFFA80DAD7387DD28B3BEE5701143FCA11A003164F79A3ADAEDDDA672BF446E2FCC0D1D6B4E52826D1"
export inviterNick2="85F3BFA5B3354165E48389A1D15831B8898933D6DB90BBAD870C521458CFD1AB49336DE54E26AA8F2834B248E6398CB7A755DF4FDAE585EC3E1ABE26F3DD3CFFC956D12974FF00A045D8E31A84FE84C18A8357DE96A1F617B8AC4D64BC24B689"
export inviterNick3=""
...
let inviterNick9 = '';
let inviterNick10 = '';
if (process.env.inviterNick) {
  inviterNick = process.env.inviterNick;
}
if (process.env.inviterNick2) {
  inviterNick2 = process.env.inviterNick2;
}
if (process.env.inviterNick3) {
  inviterNick3 = process.env.inviterNick3;
}
if (process.env.inviterNick4) {
  inviterNick4 = process.env.inviterNick4;
}
if (process.env.inviterNick5) {
  inviterNick5 = process.env.inviterNick5;
}
if (process.env.inviterNick6) {
  inviterNick6 = process.env.inviterNick6;
}
if (process.env.inviterNick7) {
  inviterNick7 = process.env.inviterNick7;
}
if (process.env.inviterNick8) {
  inviterNick8 = process.env.inviterNick8;
}
if (process.env.inviterNick9) {
  inviterNick9 = process.env.inviterNick9;
}
if (process.env.inviterNick10) {
  inviterNick10 = process.env.inviterNick10;
}
newShareCodes = [{"inviterNick":`${inviterNick}`},{"inviterNick":`${inviterNick2}`},{"inviterNick":`${inviterNick3}`},{"inviterNick":`${inviterNick4}`},{"inviterNick":`${inviterNick5}`},{"inviterNick":`${inviterNick6}`},{"inviterNick":`${inviterNick7}`},{"inviterNick":`${inviterNick8}`},{"inviterNick":`${inviterNick9}`},{"inviterNick":`${inviterNick10}`}] //这里修改你的邀请码
...
function gettask() {
    return new Promise(async (resolve) => {
let options = {
    url: `https://jinggengjcq-isv.isvjcloud.com/dm/front/foodRunning/DailyTask?open_id=&mix_nick=&bizExtString=&user_id=10299171`,

    body: `{"jsonRpc":"2.0","params":{"commonParameter":{"appkey":"51B59BB805903DA4CE513D29EC448375","m":"POST","sign":"ee5f9e1cd4d4f40e297a0cce3d7c5ab4","timestamp":1624985621185,"userId":10299171},"admJson":{"method":"/foodRunning/DailyTask","actId":"jd_food_running","buyerNick":"${nick}","pushWay":1,"userId":10299171}}}`,
headers: {
"Origin": "https://jinggengjcq-isv.isvjcloud.com",
"Content-Type": "application/json; charset=UTF-8",
...
"User-Agent": "jdapp;android;10.0.4;10;7303439343432346-7356431353233323;network/4g;model/PCAM00;addressid/4228801336;aid/7049442d7e415232;oaid/;osVer/29;appBuild/88641;partner/oppo;eufv/1;jdSupportDarkMode/0;Mozilla/5.0 (Linux; Android 10; PCAM00 Build/QKQ1.190918.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/77.0.3865.120 MQQBrowser/6.2 TBS/045227 Mobile Safari/537.36",
 ...
 $.post(options, async (err, resp, data) => {
            try {
                    ...
                    if(reust.errorCode == 200){
                   tasklist = reust.data.data 
                   for (let i = 0; i < tasklist.length; i++) {
                   type = tasklist[i].type
                   dayTop = tasklist[i].dayTop 
                   actId = tasklist[i].actId
                   await dotask(type,dayTop,actId)
...
let options = {
    ...
    body: `{"jsonRpc":"2.0","params":{"commonParameter":{"appkey":"51B59BB805903DA4CE513D29EC448375","m":"POST","sign":"3a4b12fe8d85b42c2f5defb8d642f043","timestamp":1625035211650,"userId":10299171},"admJson":{"coin":20000,"point":20000,"method":"/foodRunning/SendCoin","actId":"jd_food_running","buyerNick":"${nick}","pushWay":1,"userId":10299171}}}`,
headers: {
"Origin": "https://jinggengjcq-isv.isvjcloud.com",
"Content-Type": "application/json; charset=UTF-8",
"X-Requested-With": "XMLHttpRequest",
...
function dotask(missionType,goodsNumId,actId) {
    return new Promise(async (resolve) => {
let options = {
    url: `https://jinggengjcq-isv.isvjcloud.com/dm/front/foodRunning/complete/mission?open_id=&mix_nick=&bizExtString=&user_id=10299171`,

    body: `{"jsonRpc":"2.0","params":{"commonParameter":{"appkey":"51B59BB805903DA4CE513D29EC448375","m":"POST","sign":"aec9e190ddb8ab9798f35eb4e2a3de03","timestamp":1625027867447,"userId":10299171},"admJson":{"goodsNumId":${goodsNumId},"missionType":"${missionType}","method":"${actId}","actId":"jd_food_running","buyerNick":"${nick}","pushWay":1,"userId":10299171}}}`,
headers: {
"Origin": "https://jinggengjcq-isv.isvjcloud.com",
"Content-Type": "application/json; charset=UTF-8",
"X-Requested-With": "XMLHttpRequest",
...
function opencard (shopId) {
    return new Promise(async (resolve) => {
let options = {
    url: `https://jinggengjcq-isv.isvjcloud.com/dm/front/foodRunning/isOpen?open_id=&mix_nick=&bizExtString=&user_id=10299171`,

    body: `{"jsonRpc":"2.0","params":{"commonParameter":{"appkey":"51B59BB805903DA4CE513D29EC448375","m":"POST","sign":"e0c28f323a7e07d87d26f00d69d39603","timestamp":1625028676418,"userId":10299171},"admJson":{"shopId":${shopId},"method":"/foodRunning/isOpen","actId":"jd_food_running","buyerNick":"${nick}","pushWay":1,"userId":10299171}}}`,
headers: {
"Origin": "https://jinggengjcq-isv.isvjcloud.com",
"Content-Type": "application/json; charset=UTF-8",
"X-Requested-With": "XMLHttpRequest",
